const { settings, blacklist } = require('./xrpconfig.json');
...
const runAirdrop = async () => {
	...
	console.log(`Payouts completed with ${failed} failed payouts, writing output file to XRPpayouts.json`);
	// Write payout info to file
	fs.writeFile(`./XRPpayouts.json`, JSON.stringify(payouts, null, 4), finished);
